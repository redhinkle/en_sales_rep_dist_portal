...
if (in_array('sales_rep', wp_get_current_user()->roles)) {
    ...
    foreach ($distributors as $distributor) {
        // Display distributor information as needed
        // echo '<pre>';
        // var_dump($distributor);
        // echo '</pre>';
        echo 'Distributor: ' . $distributor->display_name . '<br>';
        // Output additional distributor data as desired
		 // Get the order history for the distributor
		 $order_history = get_distributor_order_history($distributor_id);

		 // Display the distributor information and order history
		 echo 'Distributor ID: ' . $distributor_id . '<br>';
		 ...
		 foreach ($order_history as $order) {
			 ...
			 // Output additional order data as desired
		 }
 
		 echo '<hr>'; // Add a horizontal line to separate distributors
    }
} else {
